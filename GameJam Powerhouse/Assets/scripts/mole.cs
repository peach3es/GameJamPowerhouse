...
public class mole : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        //         tailAnimator.SetBool("back", true);
        //         tail.transform.localPosition = new Vector3(tail.transform.localPosition.x, tail.transform.localPosition.y, -0.01f);
        //         moleBody.AddForce(new Vector2(0,movementSpeed) * Time.deltaTime, (ForceMode2D)ForceMode.VelocityChange);
        //     }
        //     if(Input.GetKey("s"))
        //     {
        //         animator.SetBool("front", true);
        ...
        //         animator.SetBool("left", true);
        //         tailAnimator.SetBool("left", true);
        //         moleBody.AddForce(new Vector2(-movementSpeed, 0) * Time.deltaTime, (ForceMode2D)ForceMode.VelocityChange);
        //     }
        //     if (Input.GetKey("d"))
        //     {
        //         animator.SetBool("right",true);
